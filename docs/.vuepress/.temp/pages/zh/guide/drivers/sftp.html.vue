<template><div><h1 id="sftp" tabindex="-1"><a class="header-anchor" href="#sftp"><span>SFTP</span></a></h1>
<p>即通过 SSH 协议访问文件。</p>
...
<p>SSH 密码</p>
<h2 id="私钥" tabindex="-1"><a class="header-anchor" href="#私钥"><span><strong>私钥</strong></span></a></h2>
<p>使用私钥验证而不是密码。</p>
