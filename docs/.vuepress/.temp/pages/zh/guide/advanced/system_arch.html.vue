<template><div><h1 id="alist-系统架构对应表" tabindex="-1"><a class="header-anchor" href="#alist-系统架构对应表"><span>AList 系统架构对应表</span></a></h1>
<table>
<thead>
<tr>
<th>文件名</th>
...
<tr>
<td>alist-android-arm64.tar.gz</td>
<td>Android</td>
<td>64位ARM</td>
...
<td>使用musl libc的ARM v6 EABI Linux系统</td>
</tr>
<tr>
...
<br/>
<h2 id="android-安装-alist" tabindex="-1"><a class="header-anchor" href="#android-安装-alist"><span><strong>Android 安装 AList</strong></span></a></h2>
<p>有两种办法根据自己的需求选择</p>
<ol>
<li>使用 <strong><a href="https://github.com/jing332/AListFlutter" target="_blank" rel="noopener noreferrer">https://github.com/jing332/AListFlutter</a></strong></li>
<li>使用 <code v-pre>termux</code> 运行
<ul>
<li>参考：<strong><a href="https://anwen-anyi.github.io/index/14-android_install.html" target="_blank" rel="noopener noreferrer">https://anwen-anyi.github.io/index/14-android_install.html</a></strong></li>
</ul>
</li>
</ol>
<p><i class="fa-solid fa-seal-exclamation fa-beat" style="color: #ff0000;"></i> 注意事项：记得给APP授权，后台运行、电池省电策略设置为无限制，否则可能会被杀后台导致挂在后台使用期间突然中断无法使用</p>
</div></template>
