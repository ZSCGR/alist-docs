...
```bash
curl -fsSL "https://alist-docs.chgr.cc/v3-en.sh" -o v3-en.sh && bash v3-en.sh
```
...
```bash
# Install
curl -fsSL "https://alist-docs.chgr.cc/v3-en.sh" -o v3-en.sh && bash v3-en.sh install /root
# update
curl -fsSL "https://alist-docs.chgr.cc/v3-en.sh" -o v3-en.sh && bash v3-en.sh update /root
# Uninstall
curl -fsSL "https://alist-docs.chgr.cc/v3-en.sh" -o v3-en.sh && bash v3-en.sh uninstall /root
```
